...
class SearchResultsMovieAdapter : RecyclerView.Adapter<SearchResultsMovieAdapter.ViewHolder>() {

    private val movies: ArrayList<DiscoverMovieListResult> = ArrayList()
    private val movieGenreList: ArrayList<Genre> = ArrayList()
    private lateinit var onSearchResultsMovieClickListener: OnSearchResultsMovieClickListener

    fun setData(
        movies: List<DiscoverMovieListResult>,
        movieGenreList: List<Genre>,
        onSearchResultsMovieClickListener: OnSearchResultsMovieClickListener
    ) {
        this.movies.clear()
        this.movies.addAll(movies)
        this.movieGenreList.clear()
        this.movieGenreList.addAll(movieGenreList)
        this.onSearchResultsMovieClickListener = onSearchResultsMovieClickListener
        notifyDataSetChanged()
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder = ViewHolder(
        LayoutInflater.from(parent.context).inflate(
            R.layout.item_list_activity_search_results,
            parent,
            false
    ...
    class ViewHolder(itemView: View, private val onSearchResultsMovieClickListener: OnSearchResultsMovieClickListener) :
        ...
        fun bind(movie: DiscoverMovieListResult, genres: List<Genre>) {
            ...
            itemView.itemCardView.setOnClickListener { onSearchResultsMovieClickListener.onMovieItemClick(movie) }
        }
