...
class ListMovieAdapter : RecyclerView.Adapter<ListMovieAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View, private val onListMovieClickListener: OnListMovieClickListener) :
        ...
        fun bind(movie: DiscoverMovieListResult, genres: List<Genre>) {
            ...
            itemView.itemCardView.setOnClickListener { onListMovieClickListener.onMovieItemClick(movie) }
        }
