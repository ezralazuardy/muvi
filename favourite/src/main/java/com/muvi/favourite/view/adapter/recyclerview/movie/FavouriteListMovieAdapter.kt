...
import kotlinx.android.synthetic.main.item_list_fragment_activity_favourite_list.view.*
import java.util.*

class FavouriteListMovieAdapter : RecyclerView.Adapter<FavouriteListMovieAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.item_list_fragment_activity_favourite_list,
                parent,
                false
